...
if ($street_one !== "" && $street_two == "" && $street_free == "") {
    $and = "type='квартира' AND rooms='4' AND street='" . $street_one . "'";
    $and1 = "<br />Выбрана улица <span>" . $street_one . "</span>.";    
}
else if ($street_one !== "" && $street_two !== "" && $street_free == "") {
    $and = "type='квартира' AND rooms='4' AND street='" . $street_one . "' OR type='квартира' AND rooms='4' AND street='" . $street_two . "'";
	$and1 = "<br />Выбрано две улицы: <span>" . $street_one . "</span> и <span>". $street_two . "</span>.";    
}
else if ($street_one !== "" && $street_two !== "" && $street_free !== "") {
    $and = "type='квартира' AND rooms='4' AND street='" . $street_one . "' OR type='квартира' AND rooms='4' AND street='" . $street_two . "' OR type='квартира' AND rooms='4' AND street='" . $street_free . "'";
...
// Выбор агентства
if ($firm_dop !== "") {
    $fir = "type='квартира' AND rooms='4' AND firm='" . $firm_dop . "'";
...
// Выбор цены
if ($price_dop !== "") {
    $pri = "type='квартира' AND rooms='4' AND price<='" . $price_dop . "'";
