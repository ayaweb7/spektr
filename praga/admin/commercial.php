...
$result = mysql_query("SELECT title,meta_d,meta_k,h1,h2,date,month FROM settings WHERE page='commercial'",$db);
...
<?php 
$result = mysql_query("SELECT * FROM flats_firm WHERE category='коммерческая' ORDER BY street", $db);
