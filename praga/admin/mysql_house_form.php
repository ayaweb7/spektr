...
$result = mysql_query("INSERT INTO houses (id,street,house,street_dop,house_dop,wall,walls,improved,floors,photo1,photo2,orientation) VALUES ('$id','$street','$house','$street_dop','$house_dop','$wall','$walls','$improved','$floors','$photo1','$photo2','$orientation')");
