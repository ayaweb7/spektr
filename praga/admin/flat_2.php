...
$result = mysql_query("SELECT title,meta_d,meta_k,h1,h2,date,month FROM settings WHERE page='flat_2'",$db);
...
<!-- Подключаем БЛОК выбора параметров -->
    <?php include ("blocks/parameters_flat2.php"); ?>
...
<?php include ("blocks/vybor_flat2.php");?>
