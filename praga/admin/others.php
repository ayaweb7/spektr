...
$result = mysql_query("SELECT title,meta_d,meta_k,h1,h2,date,month FROM settings WHERE page='others'",$db);
...
<?php 
$result = mysql_query("SELECT * FROM flats_firm WHERE category='другое' ORDER BY street", $db);
