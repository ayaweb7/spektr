...
$result = mysql_query("SELECT title,meta_d,meta_k,h1,h2,date,month FROM settings WHERE page='settings_update'",$db);
...
<!-- Подключаем SETTINGS_FORM_UPDATE.PHP -->
		<?php include ("blocks/settings_form_update.php"); ?>
