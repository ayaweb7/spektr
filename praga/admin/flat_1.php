...
$result = mysql_query("SELECT title,meta_d,meta_k,h1,h2,date,month FROM settings WHERE page='flat_1'",$db);
...
<!-- Подключаем БЛОК выбора параметров -->
    <?php include ("blocks/parameters_flat1.php"); ?>
...
<?php include ("blocks/vybor_flat1.php");?>
