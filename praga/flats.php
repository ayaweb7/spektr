...
?>
    ...
    <img width="100%" src="admin/images/houses/<?php echo $myrow2['photo1'] ?>.jpg" alt="Фото №1 дома <?php echo $myrow2['house'] ?> по ул.<?php echo $myrow2['street'] ?>"/>
    
    </td><td class="two" id="photo2">
    <img width="100%" src="admin/images/houses/<?php echo $myrow2['photo2'] ?>.jpg" alt="Фото №2 дома <?php echo $myrow2['house'] ?> по ул.<?php echo $myrow2['street'] ?>"/>
...
<div id="photoFlat">
     <ul>
       <li class="one" id="photo1"><a href="#" onmouseover="PhotoFlatOver2()" onmouseout="PhotoFlatOut2()"><img src="admin/images/houses/<?php echo $myrow2['photo1'] ?>.jpg" alt="Фото №1 дома <?php echo $myrow2['house'] ?> по ул.<?php echo $myrow2['street'] ?>"/></a></li>
       <li class="two" id="photo2"><a href="#" onmouseover="PhotoFlatOver12()" onmouseout="PhotoFlatOut12()"><img src="admin/images/houses/<?php echo $myrow2['photo2'] ?>.jpg" alt="Фото №2 дома <?php echo $myrow2['house'] ?> по ул.<?php echo $myrow2['street'] ?>"/></a></li>
    </ul>
 -->
