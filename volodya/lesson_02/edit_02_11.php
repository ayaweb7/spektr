<html>
	<body>
		<form action='edit_02_12.php' method='GET'>
			<label>Количество пальцев: <input type='number' name='fingercount' value='<?php echo filter_input(INPUT_GET, 'fingercount', FILTER_SANITIZE_SPECIAL_CHARS); ?>' /></label>
