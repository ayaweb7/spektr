	...
	<header class="blog-header py-3">
		<div class="row flex-nowrap justify-content-between align-items-center">
			<div class="text-center container px-4 my-4">
				<h1 class="blog-header-logo pb-2 border-bottom text-center test-custom" href="#"><?php echo $good; ?></h1>
				<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
					<ol class="breadcrumb">
						<li class='breadcrumb-item'><a href='index.php'>Главная</a></li>
						<li class="breadcrumb-item"><a href="catalog1.php">Каталог</a></li>
    ...
    <div class="col-md-9">
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
        <div class="col p-4 d-flex flex-column position-static">
          ...
          <p class="card-text mb-auto"><?php echo $myrow2['detail']; ?></p>
...
printf ("<div>
			<h1>%s</h1>
			<p><img src='img/objects/%s.jpg' alt='%s' width='264' height='191' class='leftimg'>%s</p>
		</div>", $myrow2['good'], $myrow2['photo'], $myrow2['good'], $myrow2['detail']);
