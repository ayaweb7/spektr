...
$result1 = mysqli_query($db, "SELECT * FROM settings WHERE page='store'");
$myrow1 = mysqli_fetch_array($result1);

// Подключаем HEADER
include ("blocks/header_admin.php");
?>
<form name='form' action='form_store.php' method='post'>
...
?>
				...
				<input id='check' type='submit' value='Посмотреть информацию о магазине' src='images/shop.png' alt='Товары в магазине'/>
			</td>
		</tr>
	</table>
</form>
