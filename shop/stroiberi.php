...
$result1 = mysqli_query($db, "SELECT * FROM settings WHERE page='stroiberi'");
...
<?php 
$result = mysqli_query($db, "SELECT * FROM shops WHERE gruppa='Ветряк' and shop='СтройБери' ORDER BY name, characteristic");
...
<?php 
$result = mysqli_query($db, "SELECT * FROM shops WHERE gruppa='Дерево' and shop='СтройБери' ORDER BY name, characteristic");
$myrow = mysqli_fetch_array($result);
...
<?php 
$result = mysqli_query($db, "SELECT * FROM shops WHERE gruppa='Инструмент' and shop='СтройБери' ORDER BY name, characteristic");
$myrow = mysqli_fetch_array($result);
...
<?php 
$result = mysqli_query($db, "SELECT * FROM shops WHERE gruppa='Лакокрасочные' and shop='СтройБери' ORDER BY name, characteristic");
$myrow = mysqli_fetch_array($result);
...
<?php 
$result = mysqli_query($db, "SELECT * FROM shops WHERE gruppa='Посуда' and shop='СтройБери' ORDER BY name, characteristic");
$myrow = mysqli_fetch_array($result);
...
<?php 
$result = mysqli_query($db, "SELECT * FROM shops WHERE gruppa='Расходники' and shop='СтройБери' ORDER BY name, characteristic");
$myrow = mysqli_fetch_array($result);
...
<?php 
$result = mysqli_query($db, "SELECT * FROM shops WHERE gruppa='Сад' and shop='СтройБери' ORDER BY name, characteristic");
$myrow = mysqli_fetch_array($result);
...
<?php 
$result = mysqli_query($db, "SELECT * FROM shops WHERE gruppa='Сантехника' and shop='СтройБери' ORDER BY name, characteristic");
$myrow = mysqli_fetch_array($result);
...
<?php 
$result = mysqli_query($db, "SELECT * FROM shops WHERE gruppa='Стройматериалы' and shop='СтройБери' ORDER BY name, characteristic");
$myrow = mysqli_fetch_array($result);
...
<?php 
$result = mysqli_query($db, "SELECT * FROM shops WHERE gruppa='Химия' and shop='СтройБери' ORDER BY name, characteristic");
$myrow = mysqli_fetch_array($result);
...
<?php 
$result = mysqli_query($db, "SELECT * FROM shops WHERE gruppa='Электрика' and shop='СтройБери' ORDER BY name, characteristic");
$myrow = mysqli_fetch_array($result);
...
?>
				...
				<caption> <!-- Заголовок таблицы -->
                    <h1>В магазине <?php echo $myrow1['h1'] ?><em><?php echo $myrow1['h2'] ?></em> оставлено:</br><em><?php echo $sum1+$sum2+$sum3+$sum4+$sum5+$sum6+$sum7.' руб.' ?></em></h1>
                 </caption>
