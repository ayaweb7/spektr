...
$query = "INSERT INTO store (id_store, date, town, id_locality, street, house, shop, phone) 
			VALUES ('$id_store', '$date', '$town', '$id_locality', '$street', '$house', '$shop', '$phone')";
...
?>
<p align="center"><a onclick="javascript: history.back(); return falshe;"><img src="images/shop.png" id="send"/></a></p>
</body>
</html>