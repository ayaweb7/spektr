...
$result1 = mysqli_query($db, "SELECT * FROM settings WHERE page='id_store_update'");
...
<form name="form" action="shop_id_store_update.php" method="post">
...
<input class="inputbuttonflat" type="submit" name="set_filter" value="ИЗМЕНИТЬ ID_STORE" style="margin-left:20px;"/>
</div>
