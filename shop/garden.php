...
$result1 = mysqli_query($db, "SELECT * FROM settings WHERE page='garden'");
...
?>
				...
				<caption> <!-- Заголовок таблицы -->
                    <h1>На <em><?php echo $myrow1['h1'] ?></em> & <em><?php echo $myrow1['h2'] ?></em> потрачено: <em><?php echo $sum.' руб.' ?></em></h1>
                  </caption>
