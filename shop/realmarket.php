...
$result1 = mysqli_query($db, "SELECT * FROM settings WHERE page='realmarket'");
...
<?php 
$result = mysqli_query($db, "SELECT * FROM shops WHERE gruppa='Ветряк' and shop='Реал Маркет' ORDER BY name, characteristic");
...
<?php 
$result = mysqli_query($db, "SELECT * FROM shops WHERE gruppa='Дерево' and shop='Реал Маркет' ORDER BY name, characteristic");
$myrow = mysqli_fetch_array($result);
...
<?php 
$result = mysqli_query($db, "SELECT * FROM shops WHERE gruppa='Инструмент' and shop='Реал Маркет' ORDER BY name, characteristic");
$myrow = mysqli_fetch_array($result);
...
<?php 
$result = mysqli_query($db, "SELECT * FROM shops WHERE gruppa='Лакокрасочные' and shop='Реал Маркет' ORDER BY name, characteristic");
$myrow = mysqli_fetch_array($result);
...
<?php 
$result = mysqli_query($db, "SELECT * FROM shops WHERE gruppa='Посуда' and shop='Реал Маркет' ORDER BY name, characteristic");
$myrow = mysqli_fetch_array($result);
...
<?php 
$result = mysqli_query($db, "SELECT * FROM shops WHERE gruppa='Расходники' and shop='Реал Маркет' ORDER BY name, characteristic");
$myrow = mysqli_fetch_array($result);
...
<?php 
$result = mysqli_query($db, "SELECT * FROM shops WHERE gruppa='Сад' and shop='Реал Маркет' ORDER BY name, characteristic");
$myrow = mysqli_fetch_array($result);
...
?>
					<tr><td colspan='4'></td><td style='background-color: #19910f; font: 1,2em bold Georgia, "Times New Roman", Times, serif; color: #FFF300;'><?php echo $sum11.' руб.' ?></td></tr>

<?php 
$result = mysqli_query($db, "SELECT * FROM shops WHERE gruppa='Сантехника' and shop='Реал Маркет' ORDER BY name, characteristic");
$myrow = mysqli_fetch_array($result);
...
<?php 
$result = mysqli_query($db, "SELECT * FROM shops WHERE gruppa='Стройматериалы' and shop='Реал Маркет' ORDER BY name, characteristic");
$myrow = mysqli_fetch_array($result);
...
<?php 
$result = mysqli_query($db, "SELECT * FROM shops WHERE gruppa='Химия' and shop='Реал Маркет' ORDER BY name, characteristic");
$myrow = mysqli_fetch_array($result);
...
<?php 
$result = mysqli_query($db, "SELECT * FROM shops WHERE gruppa='Электрика' and shop='Реал Маркет' ORDER BY name, characteristic");
$myrow = mysqli_fetch_array($result);
