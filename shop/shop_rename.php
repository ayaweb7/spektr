...
$result1 = mysqli_query($db, "SELECT * FROM settings WHERE page='shop_rename'");
...
<form name="form" action="all_shop_rename.php" method="post">
...
<input class="inputbuttonflat" type="submit" name="set_filter" value="ПОМЕНЯТЬ НАЗВАНИЕ МАГАЗИНА" style="margin-left:20px;"/>
</div>
