...
$result1 = mysqli_query($db, "SELECT * FROM settings WHERE page='mysql_store_shop_update'");
...
$result = mysqli_query($db, "UPDATE shops SET id_store='$id_store',shop='$shop' WHERE shop='$shop'");
...
<table width="100%" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<td width="32%" >
			<a href="id_store_update.php" title="На магазины"><img src="images/shop.png" id="send"/></a>
		</td>
</td></tr></table>
