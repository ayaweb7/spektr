...
function diamond_defaults( $defaults ) {
	...
	$defaults['footer_text'] = '<a href="' . __( 'http://www.wptheme.us/', 'sg-diamond' ) . '">' . __( 'Шаблоны WordPress', 'sg-diamond' ). '</a> | ' . __( 'theme ', 'sg-diamond' ) . '<a href="' .  __( 'http://wpblogs.ru/themes/blog/theme/diamond/', 'sg-diamond') . '">Diamond</a>';
