...
define( 'ADS_PLUGIN_VER', $ads_data['ver'] );
define( 'ADS_PLUGIN_NAME', $ads_data['name'] );
...
class ADS_Shortcodes {
	...
	public function init() {
		...
		if ( is_admin() ) {
			 ...
			 * Admin
			 */
			require_once ADS_PLUGIN_DIR . 'includes/class-ads-admin.php';
		...
		if ( ! is_admin() ) :
			 ...
			 * Front end
			 */
			require_once ADS_PLUGIN_DIR . 'includes/class-ads-frontend.php';
