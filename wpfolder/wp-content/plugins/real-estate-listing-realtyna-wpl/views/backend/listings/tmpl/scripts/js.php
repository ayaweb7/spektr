        ...
        ajax.success(function(data)
        {
            if(data.status == true)
            {
                for (i = 0; i < pids_array.length; i++)
                {
                    ...
                    wplj("#pmanager_facebook_publish"+pids_array[i]+" label").text("<?php echo addslashes(__('unPublish From FB', 'wpl')); ?>");
                }
            }
    ...
    function facebook_publish(pid) {
        ...
        ajax.success(function(data)
        {
            ...
            if(data.status == true)
            {
                ...
                if(confirmed) wplj("#pmanager_facebook_publish"+pid+" label").text("<?php echo addslashes(__('Publish on FB', 'wpl')); ?>");
                else wplj("#pmanager_facebook_publish"+pid+" label").text("<?php echo addslashes(__('unPublish From FB', 'wpl')); ?>");
            }
            else if(data.status == false)
            {
