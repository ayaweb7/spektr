...
<script type="text/javascript">
    ...
    function wpl_idx_wizard_already_used_trial()
    {
        ...
        success += '<p><?php echo __('You may already used the trial version or you may have valid version purchased.','wpl'); ?></p>';
        success += '<a class="wpl-button button-1" href="<?php echo wpl_global::get_wpl_admin_menu('wpl_admin_listings'); ?>"><?php echo __('Listing Manager','wpl'); ?></a>';
        //check if trial is reseted
         var is_trial_reset = <?php echo (get_option('wpl_addon_idx_trial_reseted') == 1) ? 1: 0; ?>
         
         if (is_trial_reset == 0) {
            success += '<a class="wpl-button button-1" href="#" onclick="wpl_idx_reset_trial();"><?php echo __('Reset','wpl'); ?></a>';
         }
