                                ...
                                <ul>
                                    <?php if(trim($listing_id) != ''): ?>
                                        <li class="wpl-listing-id">
                                            <?php echo __($this->wpl_properties['current']['materials']['mls_id']['name'], 'wpl').' : <span class="value">'.$listing_id.'</span>'; ?>
                                        </li>
                                    <?php endif; ?>
                                    <?php if(trim($bedroom) != ''): ?>
                                        <li class="wpl-bedroom" <?php echo $this->itemprop_numberOfRooms.' '.$this->itemscope.' '.$this->itemtype_QuantitativeValue ?>>
                                            <span <?php echo $this->itemprop_name; ?> ><?php echo __($this->wpl_properties['current']['materials']['bedrooms']['name'], 'wpl').' : </span> <span '.$this->itemprop_value.' class="value">'.$bedroom.'</span>'; ?>
                                        </li>
                                    <?php endif; ?>
                                    <?php if(trim($bathroom) != ''): ?>
                                        <li class="wpl-bathroom" <?php echo $this->itemprop_numberOfRooms.' '.$this->itemscope.' '.$this->itemtype_QuantitativeValue ?>>
                                            <span <?php echo $this->itemprop_name; ?>><?php echo __($this->wpl_properties['current']['materials']['bathrooms']['name'], 'wpl').' : </span> <span '.$this->itemprop_value.' class="value">'.$bathroom.'</span>'; ?>
                                        </li>
                                    <?php endif; ?>
                                    <?php if(trim($build_up_area) != ''): ?>
                                        <li class="wpl-build-up-area">
                                            <?php echo __($build_up_area_name, 'wpl').' : <span class="value" '.$this->itemprop_floorSize.' '.$this->itemscope.' '.$this->itemtype_QuantitativeValue.'><span class="value" '.$this->itemprop_value.'>'.$build_up_area.'</span></span>'; ?>
                                        </li>
                                    <?php endif; ?>
                                    <?php if($price_type): ?>
                                        <li class="wpl-price">
                                            <?php echo __($this->wpl_properties['current']['materials']['price_period']['name'], 'wpl').' : <span class="value">'.$price_type.'</span>'; ?>
                                        </li>
                                    <?php endif; ?>
