...
<div class="wpl_agents_widget_backend_form wpl-widget-form-wp" id="<?php echo $this->get_field_id('wpl_agents_widget_container'); ?>">
    ...
    <div class="wpl-widget-row">
        <label for="<?php echo $this->get_field_id('data_lazyload'); ?>"><?php echo __('Lazyload', 'wpl'); ?></label>
        <select class="text_box" name="<?php echo $this->get_field_name('data'); ?>[lazyload]" id="<?php echo $this->get_field_id('data_lazyload'); ?>">
            <option value="0" <?php if(isset($instance['data']['lazyload']) and $instance['data']['lazyload'] == '0') echo 'selected="selected"'; ?>><?php echo __('No', 'wpl'); ?></option>
            <option value="1" <?php if(isset($instance['data']['lazyload']) and $instance['data']['lazyload'] == '1') echo 'selected="selected"'; ?>><?php echo __('Yes', 'wpl'); ?></option>
        </select>
    </div>
