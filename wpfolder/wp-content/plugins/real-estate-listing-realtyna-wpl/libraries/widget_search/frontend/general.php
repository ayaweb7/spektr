...
elseif($type == 'number' and !$done_this)
{
    ...
    elseif($show == 'minmax')
    {
		...
		$html .= '<input name="sf'.$widget_id.'_tmin_'.$field_data['table_column'].'" type="text" id="sf'.$widget_id.'_tmin_'.$field_data['table_column'].'" value="'.(trim(wpl_request::getVar('sf_tmin_'.$field_data['table_column'])) != '' ? $current_min_value : (isset($extoptions[0]) ? $extoptions[0] : '')).'" placeholder="'.__('Min', 'wpl').'" />';
        
		$html .= '<label class="wpl_search_widget_to_label" for="sf'.$widget_id.'_tmax_'.$field_data['table_column'].'">'.__('Max', 'wpl').'</label>';
		$html .= '<input name="sf'.$widget_id.'_tmax_'.$field_data['table_column'].'" type="text" id="sf'.$widget_id.'_tmax_'.$field_data['table_column'].'" value="'.(trim(wpl_request::getVar('sf_tmax_'.$field_data['table_column'])) != '' ? $current_max_value : (isset($extoptions[1]) ? $extoptions[1] : '')).'" placeholder="'.__('Max', 'wpl').'" />';
	}
...
elseif(($type == 'area' or $type == 'mmarea' or $type == 'volume' or $type == 'mmvolume' or $type == 'length' or $type == 'mmlength') and !$done_this)
{
	...
	if($show == 'minmax')
	{
		...
		$html .= '<input name="sf'.$widget_id.'_min_'.$min_column.'" type="'.$input_type.'" id="sf'.$widget_id.'_min_'.$min_column.'" value="'.(trim(wpl_request::getVar('sf_min_'.$min_column)) != '' ? $current_min_value : (isset($extoptions[0]) ? $extoptions[0] : '')).'" placeholder="'.__('Min', 'wpl').'" />';
		...
		$html .= '<input name="sf'.$widget_id.'_max_'.$max_column.'" type="'.$input_type.'" id="sf'.$widget_id.'_max_'.$max_column.'" value="'.(trim(wpl_request::getVar('sf_max_'.$max_column)) != '' ? $current_max_value : (isset($extoptions[1]) ? $extoptions[1] : '')).'" placeholder="'.__('Max', 'wpl').'" />';
	}
	elseif($show == 'minmax_slider')
	{
        wpl_html::set_footer('<script type="text/javascript">
