		...
		<div class="row g-5">
			<div class="col-md-8">
				...
				<p>
					...
					<p><?php echo $myrow2['good']; ?> продаётся оптом и в розницу по доступным ценам в нашем магазине.<br> Сделать заказ прямо на нашем сайте можно нажав на кнопку <a href="#">"Сделать заявку".</a><br> Вы также можете оформить заказ и доставку по телефону, нажав на кнопку <a class="" href="tel:+79115518191" >"Позвонить"</a> или <a href="#">"Заказать звонок"</a>.</p>
				</p>
<?php
