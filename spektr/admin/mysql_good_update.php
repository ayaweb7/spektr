...
$result1 = mysqli_query($db, "SELECT * FROM pages WHERE page='mysql_good_update'");
...
//$id = (int) $id;
	...
	p1='$p1', p2='$p2', p3='$p3', title_g1='$title_g1', title_g2='$title_g2', title_g3='$title_g3', name_title='$name_title', size_title='$size_title', size_1='$size_1', size_2='$size_2', size_3='$size_3', title_price='$title_price', g1='$g1', g2='$g2', g3='$g3', depth='$depth', width='$width', price='$price', price_title_1='$price_title_1', price_title_2='$price_title_2', item='$item' WHERE id='$id'";
