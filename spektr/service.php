		...
		<div class="row g-5">
			<div class="col-md-8">
				...
				<p>
					...
					<p>Получить консультацию Вы можете по телефону: <a class="" href="tel:+79115518191" >+7 (911) 551-81-91.</a><br>Вы можете также <a href="#">Заказать обратный звонок</a> и Вам перезвонят в указанное Вами время.</p>
				</p>
<?php
